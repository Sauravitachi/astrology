    ...
    <div className="fixed bottom-6 right-6 z-[90] flex flex-col items-end">
        ...
        <div className="glass-card rounded-[24px] w-[90vw] max-w-[360px] mb-4 overflow-hidden origin-bottom-right transition-all duration-300">
          <div className="p-6 relative">
            ...
            <form onSubmit={handleSend} className="space-y-3 relative z-10">
              <input required type="text" name="fullName" placeholder={t('name_placeholder')} value={formData.fullName} onChange={handleChange} className="w-full px-4 py-3 rounded-[12px] border border-white/10 text-[14px] text-white focus:outline-none focus:border-gold-500/50 focus:ring-1 focus:ring-gold-500/50 bg-white/5 placeholder:text-white/30 transition-colors" />
              <input required type="tel" name="phoneNumber" placeholder={t('phone_placeholder')} value={formData.phoneNumber} onChange={handleChange} className="w-full px-4 py-3 rounded-[12px] border border-white/10 text-[14px] text-white focus:outline-none focus:border-gold-500/50 focus:ring-1 focus:ring-gold-500/50 bg-white/5 placeholder:text-white/30 transition-colors" />
              <input type="email" name="email" placeholder={t('email_placeholder')} value={formData.email} onChange={handleChange} className="w-full px-4 py-3 rounded-[12px] border border-white/10 text-[14px] text-white focus:outline-none focus:border-gold-500/50 focus:ring-1 focus:ring-gold-500/50 bg-white/5 placeholder:text-white/30 transition-colors" />
              <input required type="text" name="country" placeholder={t('country_placeholder')} value={formData.country} onChange={handleChange} className="w-full px-4 py-3 rounded-[12px] border border-white/10 text-[14px] text-white focus:outline-none focus:border-gold-500/50 focus:ring-1 focus:ring-gold-500/50 bg-white/5 placeholder:text-white/30 transition-colors" />
              <input type="text" name="consultationType" placeholder={t('consult_type_placeholder')} value={formData.consultationType} onChange={handleChange} className="w-full px-4 py-3 rounded-[12px] border border-white/10 text-[14px] text-white focus:outline-none focus:border-gold-500/50 focus:ring-1 focus:ring-gold-500/50 bg-white/5 placeholder:text-white/30 transition-colors" />
      ...
      >
        ...
        <div className="text-left py-1 relative z-10">
          <div className="text-[14px] font-display font-bold text-white leading-tight">{t('team_acharya')}</div>
