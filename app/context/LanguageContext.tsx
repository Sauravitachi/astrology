...
const translations = {
  en: {
    ...
    acharya_name: "Acharya Ravi",
    about_p1: "Namaste! I am Acharya Ravi, a dedicated Vedic astrologer with over 25 years of experience in helping individuals find clarity and purpose.",
